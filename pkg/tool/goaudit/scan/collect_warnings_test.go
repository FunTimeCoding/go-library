...
func TestWarningNoSuffix(t *testing.T) {
	v := virtual_file_system.New()
	v.Write("pkg/tool/gotest/server/r.go", "package server\n")
	v.Write("pkg/tool/gotest/option/o.go", "package option\n")
...
func TestWarningRouteExists(t *testing.T) {
	v := virtual_file_system.New()
	v.Write("pkg/tool/gotestd/server/r.go", "package server\n")
	v.Write("pkg/tool/gotestd/route/r.go", "package route\n")
	v.Write("pkg/tool/gotestd/option/o.go", "package option\n")
	v.Write("pkg/tool/gotestd/run.go", "package gotestd\n")
...
func TestWarningConstantFile(t *testing.T) {
	v := virtual_file_system.New()
	v.Write("pkg/tool/gotestd/server/r.go", "package server\n")
	v.Write("pkg/tool/gotestd/constant.go", "package gotestd\n")
	v.Write("pkg/tool/gotestd/option/o.go", "package option\n")
	v.Write("pkg/tool/gotestd/run.go", "package gotestd\n")
