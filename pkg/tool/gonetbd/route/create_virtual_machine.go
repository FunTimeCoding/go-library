...
func (h *Router) CreateVirtualMachine(w http.ResponseWriter, q *http.Request) {
	...
	errors.PanicOnError(json.NewEncoder(w).Encode(generated.VirtualMachine{Identifier: vm.Identifier, Name: vm.Name, Cluster: &cl.Name}))
}
